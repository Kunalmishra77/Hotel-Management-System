...
const MATRIX: Record<Permission, MatrixRow> = {
  ...
  "room:manage": { ADMINISTRATOR: A, MANAGER: A },
  "room:view-status": {
    ADMINISTRATOR: A,
    MANAGER: A,
    RECEPTION: A,
  ...
  "reservation:view": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "reservation:create": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A },
  "reservation:modify": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A },
  "reservation:cancel": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: L },
  "checkin:perform": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A },
  "checkout:perform": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A },
  "guest:view": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "guest:view-pii": { ADMINISTRATOR: A, MANAGER: L, RECEPTION: L, ACCOUNTS: L },
  "guest:create": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A },
  "guest:delete": { ADMINISTRATOR: L },
  "folio:view": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "folio:charge": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "folio:discount": { ADMINISTRATOR: A, MANAGER: L, RECEPTION: L, ACCOUNTS: L },
  "folio:refund": { ADMINISTRATOR: L, MANAGER: L, ACCOUNTS: L },
  "invoice:generate": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "invoice:void": { ADMINISTRATOR: L, MANAGER: L, ACCOUNTS: L },
  "payment:record": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "expense:create": { ADMINISTRATOR: A, MANAGER: A, ACCOUNTS: A },
  "expense:approve": { ADMINISTRATOR: A, MANAGER: L, ACCOUNTS: L },
  "report:view-operational": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "report:view-financial": { ADMINISTRATOR: A, MANAGER: A, ACCOUNTS: A },
  "staff:manage": { ADMINISTRATOR: A, MANAGER: A },
  "payroll:run": { ADMINISTRATOR: L, MANAGER: L, ACCOUNTS: L },
  "housekeeping:update": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, HOUSEKEEPING: A },
  "maintenance:manage": { ADMINISTRATOR: A, MANAGER: A, MAINTENANCE: A },
  "communication:send": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "communication:template-manage": { ADMINISTRATOR: A, MANAGER: L },
  "integration:manage": { ADMINISTRATOR: L },
  "export:data": { ADMINISTRATOR: A, MANAGER: A, ACCOUNTS: A },
  "export:pii": { ADMINISTRATOR: L, MANAGER: L, ACCOUNTS: L },
  "user:manage": { ADMINISTRATOR: L },
  "ai:use": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "settings:manage": { ADMINISTRATOR: L, MANAGER: L },
  "folio:defer": { ADMINISTRATOR: L, MANAGER: L, ACCOUNTS: L },
  "guest:manage": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A },
  "guest:merge": { ADMINISTRATOR: L, MANAGER: L, RECEPTION: L },
  "pos:order-create": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "pos:order-settle": { ADMINISTRATOR: A, MANAGER: A, RECEPTION: A, ACCOUNTS: A },
  "pos:order-void": { ADMINISTRATOR: L, MANAGER: L, ACCOUNTS: L },
  "inventory:manage": { ADMINISTRATOR: A, MANAGER: A, ACCOUNTS: A },
  "pricing:approve": { ADMINISTRATOR: L, MANAGER: L },
  "corporate:manage": { ADMINISTRATOR: A, MANAGER: A, ACCOUNTS: A },
  "bookingengine:manage": { ADMINISTRATOR: L, MANAGER: L },
  "coupon:manage": { ADMINISTRATOR: A, MANAGER: A, ACCOUNTS: A },
