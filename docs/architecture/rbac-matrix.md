...
Columns are the 13 login roles (staff without a login — housekeeping/room-service/security-guard/etc. — are managed by their supervisor and never appear here). Asst = Assistant Manager · Inv = Inventory/Store Manager · Pur = Purchase Manager · POS = POS/Restaurant Manager · Sec = Security Supervisor · Laundry = Laundry Supervisor.

| Permission | Admin | Manager | Asst | Reception | Accounts | HR | Inv | Pur | POS | Housekeeping | Maintenance | Sec | Laundry |
|---|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| property:manage | ✔ | 🔒 |  |  |  |  |  |  |  |  |  |  |  |
| room:manage | ✔ | ✔ | ✔ |  |  |  |  |  |  |  |  |  |  |
| room:view-status | ✔ | ✔ | ✔ | ✔ | ✔ |  | ✔ |  | ✔ | ✔ | ✔ | ✔ | ✔ |
